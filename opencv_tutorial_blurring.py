...
if __name__ == '__main__':
    ...
    for i in range(0,len(kernel_size)):
        ...
        #If kernel size[i] bigger than one it means blur filter applied to image but if it's 1 it means original image. kernel_size describe searching space or neighbors and
        # 1 size searching space represent original version
